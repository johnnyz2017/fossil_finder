...
import 'package:fossils_finder/utils/net.dart';
...
class QiniuApi {
  ...
  static String generateUpToken(
    ...
    print('##QINIU## getnerateUpToken: with AK::$accessKey, SK::$secretKey, putpolicy::$encodePutPolicy');
    ...
    print('token is :: $accessKey:$encodeSign:$encodePutPolicy');
  ...
  static String generatePutPolicy(String bucket, String key) {
    Map<String, dynamic> map = {
      ...
      'scope': '$bucket',    //11111
      // 'deadline': 1602996686 //22222
      'deadline': DateTime.now().millisecondsSinceEpoch + 60 * 60 //22222
    };
