...
import 'package:fossils_finder/api/qiniu_api.dart';
import 'package:fossils_finder/model/qiniu_config.dart';
import 'package:fossils_finder/model/uploaded.dart';
import 'package:fossils_finder/utils/image_upload.dart';
import 'package:fossils_finder/utils/image_upload_strategy.dart';
...
class QiniuImageUpload extends ImageUploadStrategy {
  ...
  Future<Uploaded> upload(File file, String renameImage) async {
    try {
      // String configStr = await ImageUploadUtils.getPBConfig("qiniu");
      String configStr = await rootBundle.loadString('assets/data/qiniu.json');
